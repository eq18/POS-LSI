...
'Input PLU'
Windows.setText(findWindowsObject('Object Repository/Transaksi Kasir/txt_PLU'), findTestData('PLU - DB').getValue(1, 6))
...
Windows.comment(startTime)

Windows.comment(endTime)

...
'Load Excel'
TestData td = TestDataFactory.findTestData('Promotion Folder/Promo Multilevel - Promo Price and PWP')
...
long expected5 = td.getValue('expected', 5).toLong()

long expected6 = td.getValue('expected', 6).toLong()

long grandTotalExpected2 = ((expected3 + expected3) + expected5) + expected6

...
promo = 'Voucher Supplier Max Purchase 1'
...
'Load Excel'
TestData td = TestDataFactory.findTestData('Promotion Folder/Voucher Supplier - Max Purchase 1')
...
'Pilih list voucher'
Windows.click(findWindowsObject('Voucher Supplier/list_voucher'))
...
voucher = Windows.getText(findWindowsObject('Voucher Supplier/voucher'))

Windows.comment('Nama Voucher = ' + voucher)

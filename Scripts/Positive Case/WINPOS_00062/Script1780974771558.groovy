...
Windows.click(findWindowsObject('Penjualan_Voucher/btn_penjualanVoucher'))

Windows.setText(findWindowsObject('Object Repository/Penjualan_Voucher/txt_nomorVoucherFrom'), from)

Windows.setText(findWindowsObject('Object Repository/Penjualan_Voucher/txt_nomorVoucherTo'), to)

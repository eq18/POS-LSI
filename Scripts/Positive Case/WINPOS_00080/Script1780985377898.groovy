...
'Transaksi Virtual'
Windows.click(findWindowsObject('Transaksi_Virtual/btn_TrnVirtual'))

Windows.takeScreenshot()

Windows.click(findWindowsObject('Transaksi_Virtual/btn_paymentPoint'))

CustomKeywords.'custom.WindowUtils.switchToWindowTitle'('frmPaymentPoint_Revamp')

Windows.click(findWindowsObject('Transaksi_Virtual/txt_cari'))

Windows.setText(findWindowsObject('Transaksi_Virtual/txt_cari'), cari)

def btnYa = findWindowsObject('Transaksi_Virtual/btn_koneksiGagalYa')

if (Windows.verifyElementPresent(btnYa, 1, FailureHandling.OPTIONAL)) {
    Windows.click(btnYa)
}

//if (Windows.verifyElementPresent(findWindowsObject('Transaksi_Virtual/btn_koneksiGagalYa'), 1, FailureHandling.OPTIONAL)) {
 //   Windows.click(findWindowsObject('Transaksi_Virtual/btn_koneksiGagalYa'))
//}
...
Windows.sendKeys(findWindowsObject('Transaksi_Virtual/txt_cari'), Keys.chord(Keys.ENTER))

Windows.click(findWindowsObject('Transaksi_Virtual/txt_noHp'))

Windows.setText(findWindowsObject('Transaksi_Virtual/txt_noHp'), noHp)

Windows.click(findWindowsObject('Transaksi_Virtual/txt_kodeBayar'))

Windows.setText(findWindowsObject('Transaksi_Virtual/txt_kodeBayar'), kodeBayar)

Windows.sendKeys(findWindowsObject('Transaksi_Virtual/txt_kodeBayar'), Keys.chord(Keys.ENTER))

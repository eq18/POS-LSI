...
promo = 'Promo Suprise Gift and Bank, Minimal belanja 200.000 Free Parkir'
...
'Load Excel'
TestData td = TestDataFactory.findTestData('Promotion Folder/Promo Suprise Gift and Bank - Free Parkir')
...
Windows.click(findWindowsObject('Transaksi Kasir/btn_YA'))

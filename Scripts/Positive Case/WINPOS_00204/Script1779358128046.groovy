...
'Load Excel'
TestData td = TestDataFactory.findTestData('Promotion Folder/Promo Multilevel - Promo Price and Disc Rp')
...
for (int x = 1; x <= 3; x++) {
    ...
    if (x == 1) {
		...
		actualDiskonStr = Windows.getText(findWindowsObject('Transaksi Kasir/lbl_diskon_3'))
	}

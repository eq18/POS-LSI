...
'Load Excel'
TestData td = TestDataFactory.findTestData('Promotion Folder/Promo Suprise Gift and Bank - Based on Product')
...
'Validasi'
assert pdfText.contains('ANDA MENDAPATKAN GRATIS 1 PCS SAMPLE CONFIDENCE')

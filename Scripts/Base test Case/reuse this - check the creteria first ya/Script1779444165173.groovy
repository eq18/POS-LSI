...
/*GUNAKAN TC INI JIKA:
 ...
 2. ADA 2 PEMBAYARAN
 3. Transaksi Pertama ada 2 row, transaksi kedua ada 1 row
 */
...
'Load Excel'
TestData td = TestDataFactory.findTestData('Promotion Folder/Package Beli 1 Gratis 1')
...
long grandTotalExpected1 = expected1 + expected2
...
// ROW 3
// ======================================================
String plu3 = td.getValue('plu', 3)

String qty3 = td.getValue('qty', 3)

KeywordUtil.logInfo('INPUT PLU 3 = ' + plu3)

KeywordUtil.logInfo('INPUT QTY 3 = ' + qty3)
...
Windows.sendKeys(findWindowsObject('Transaksi Kasir/txt_PLU'), plu3)
...
// INPUT QTY
// ==============================================
Windows.setText(findWindowsObject('Transaksi Kasir/txt_PLU'), qty3)

...
//CustomKeywords.'custom.WindowUtils.switchToWindowTitle'('Main Menu (PT Lion Super Indo v.2.1.1.71)')

//CustomKeywords.'custom.WindowUtils.switchToWindowTitle'('PT Lion Super Indo v.2.1.1.71')

Windows.switchToWindowTitle('PT Lion Super Indo v.2.1.1.71')
